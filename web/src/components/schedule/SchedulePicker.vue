    ...
    return catalogue.filter(subject => {
        ...
        if (course.value === "optativas") {
            ...
            if (
                ...
                !subject.courses.includes(course.value)
            ) {
                return false;
            }
        }
    ...
    <section class="picker">
        ...
        >
            <span class="headLabel eyebrow">
                Tus asignaturas<template v-if="selectedSubjects.length">
                    · {{ selectedSubjects.length }}</template
                >
            </span>
        ...
        <div v-if="selectedSubjects.length" class="selection">
            <span
            ...
            >
                ...
                >
                    <UiIcon name="close" :size="8" :width="2.2" />
                </button>
            </span>

            <button type="button" class="clear" @click="clear">vaciar</button>
        ...
        <div v-if="open" class="chooser">
            ...
            <div class="chips">
                <UiChip :active="course === 'todos'" @click="course = 'todos'">
                    Todas
                </UiChip>
                <UiChip
                    v-for="n in 4"
                ...
                <li v-for="subject in visible" :key="subject.code">
                    ...
                    >
                        ...
                        <span class="identity">
                            ...
                            <span class="meta">
                                {{ meta(subject)
                                }}<template v-if="!subject.available">
                                    ·
