...
<template>
    <div class="screen">
        <header class="intro">
            ...
            <div class="stats">
                <UiStat :value="total" label="optativas" tone="gold" />
                <UiStat :value="enrolmentPerYear" label="matrículas al año" />
                <UiStat :value="pct(averagePass)" label="aprueban de media" />
            </div>
        </header>
        ...
        <p class="footnote">
            ...
            20 créditos (4 asignaturas) · medias de 3 cursos · ⚠ = menos de 10
            alumnos.
        </p>
    </div>
</template>
